...
// 2D vectors
//
// Setting these up here because I need them
//

typedef struct { float x, y; } vec2_t;
static inline vec2_t vec2(float x, float y)        { return (vec2_t){ x, y }; }
static inline vec2_t vec2s(float f)                { return (vec2_t){ f, f }; }
#define v2(v) v.x, v.y

static inline vec2_t v2_neg(vec2_t v) { return vec2(-v.x, -v.y); }
static inline vec2_t v2_add(vec2_t a, vec2_t b) { return vec2(a.x + b.x, a.y + b.y); }
static inline vec2_t v2_sub(vec2_t a, vec2_t b) { return vec2(a.x - b.x, a.y - b.y); }
static inline vec2_t v2_mul(vec2_t a, vec2_t b) { return vec2(a.x * b.x, a.y * b.y); }
static inline vec2_t v2_muls(vec2_t v, float f) { return vec2(v.x * f, v.y * f); }
...
static inline vec3_t vec3s(float f)			    { return (vec3_t){ f, f, f }; }
